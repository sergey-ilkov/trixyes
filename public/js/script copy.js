            ...
            <div class="credit-service__col">
                <ul class="credit-service__list">
                    <li class="credit-service__item">
                        <span>Від ${data.interest}% </span>- ставка в день
                    </li>
                    <li class="credit-service__item">
                        <span>До ${data.term} днів </span>- макс. термін
                    </li>
                    <li class="credit-service__item">
                        <span>До ${data.amount.toLocaleString('uk')} грн </span>- макс. сума
                    </li>
                </ul>
            </div>
            <div class="credit-service__col">
                <div class="credit-service-stars">${starsHtml}</div>
                <span class="credit-service__rating">(${data.vote_count} голосів)</span>
            </div>
            <div class="credit-service__col">
                <div class="credit-service-chart">${chartHtml}</div>
            </div>
            <div class="credit-service__col">
                <a class="credit-service__link btn-1 service-link" target="_blank" href="${data.url}">Отримати позику</a>
            </div>
            <div class="credit-service__col">
                    ...
                    <div class="credit-service-box__accordion">
                        ...
                        <button class="credit-service-box__btn btn-details" type="button">
                            <span class="credit-service-box__btn-wrapper">
                                <span class="credit-service-box__btn-text-show">Детальніше</span>
                                <span class="credit-service-box__btn-text-hidden">Приховати</span>
                            </span>
            ...
            <div class="credit-service__col">
                <button class="credit-service__btn credit-service__btn-hidden btn-hidden" type="button">
                    ...
                    <span class="credit-service__btn-wrapper">
                        <span class="credit-service__btn-text-hidden">Сховати</span>
                        <span class="credit-service__btn-text-show">Відобразити</span>
                    </span>
                </button>
                <button class="credit-service__btn credit-service__btn-history btn-history" type="button">
                    ...
                    <span class="credit-service__btn-text">Історія кредитів</span>
                </button>
            </div>
        </div>  
    `;
