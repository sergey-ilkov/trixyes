        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('admin.reviews.update', $review->id) }}" method="PUT" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="name" value="{{ $review->name }}" style="max-width: 300px" />
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="surname" value="{{ $review->surname }}" style="max-width: 300px" />
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="rating" value="{{ $review->rating }}" type="number" style="max-width: 300px" />
                            ...
                            <div class="card-body__group summernote-editor">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.summernote name="text">{{ $review->text }}</x-admin.summernote>
                                </x-admin.form-item>
                            </div>
