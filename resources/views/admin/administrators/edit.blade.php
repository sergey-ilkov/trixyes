        ...
        <div class="content__item">
            <div class="card">
                ...
                <h3 class="card__title title-h3">
                    ...
                    {{__('admin.title.administrators-edit')}}
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('administrators.update', $admin->id) }}" method="PUT" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="login" value="{{ $admin->login }}" style="max-width: 300px" />
