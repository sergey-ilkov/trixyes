        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('admin.actions.update', $action->id) }}" method="PUT" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                @if ($errors->has('name.' . $language->code))
                                    ...
                                    <x-admin.input name="name[{{ $language->code }}]" class="input-error" value="{{ old('name.' . $language->code) ? : $action->getTranslation('name', $language->code) }}" style="max-width: 300px" />
                                
                                @else

                             
                                    <x-admin.input name="name[{{ $language->code }}]" value="{{ old('name.' . $language->code) ? : $action->getTranslation('name', $language->code) }}" style="max-width: 300px" />
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="slug" value="{{ $action->slug }}" style="max-width: 300px" />
