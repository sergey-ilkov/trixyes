        ...
        <div class="content__item">
            <div class="card">
                ...
                <h3 class="card__title title-h3">
                    ...
                    {{__('admin.title.service-categories-create')}}
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('admin.service-categories.store') }}" method="POST" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                @if ($errors->has('title.' . $language->code))
                                    ...
                                    <x-admin.input name="title[{{ $language->code }}]" class="input-error" value="{{ old('title.' . $language->code) }}"  />
