        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('admin.services.update', $service->id) }}" enctype="multipart/form-data" method="PUT" class="card-form">
                        ...
                        <div class="card-body__group">
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="name[{{ $language->code }}]" class="input-error" value="{{ old('name.' . $language->code) ? : $service->getTranslation('name', $language->code) }}" />

                                @else

                                <x-admin.input name="name[{{ $language->code }}]" value="{{ old('name.' . $language->code) ? : $service->getTranslation('name', $language->code) }}" />
                        ...
                        <div class="card-body__group">
                            <div class="image-add-group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input-file name="icon" type="file" />
                        ...
                        <div class="card-body-row">
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->interset }}" type="number" name="interset" min="0.01" max="100" step="0.01" style="width: 200px" />
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->term }}" type="number" name="term" min="1" step="1" style="width: 200px" />
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->amount }}" type="number" name="amount" min="1" step="1" style="width: 200px" />
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->promo_discount }}" type="number" name="promo_discount" min="1" step="1" style="width: 200px" />
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->vote_rating }}" type="number" name="vote_rating" min="1" max="10" step="1" style="width: 200px" />
                            ...
                            <div class="card-body__group">
                                <x-admin.form-item>
                                    ...
                                    <x-admin.input value="{{ $service->vote_count }}" type="number" name="vote_count" min="1" step="1" style="width: 200px" />
                        ...
                        <div class="card-body__group">
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="license[{{ $language->code }}]" class="input-error" value="{{ old('license.' . $language->code) ? : $service->getTranslation('license', $language->code) }}" />

                                @else

                                <x-admin.input name="license[{{ $language->code }}]" value="{{ old('license.' . $language->code) ? : $service->getTranslation('license', $language->code) }}" />
                        ...
                        <div class="card-body__group">
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="comp_name[{{ $language->code }}]" class="input-error" value="{{ old('comp_name.' . $language->code) ? : $service->getTranslation('comp_name', $language->code) }}" />

                                @else

                                <x-admin.input name="comp_name[{{ $language->code }}]" value="{{ old('comp_name.' . $language->code) ? : $service->getTranslation('comp_name', $language->code) }}" />
                        ...
                        <div class="card-body__group">
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="address[{{ $language->code }}]" class="input-error" value="{{ old('address.' . $language->code) ? : $service->getTranslation('address', $language->code) }}" />

                                @else

                                <x-admin.input name="address[{{ $language->code }}]" value="{{ old('address.' . $language->code) ? : $service->getTranslation('address', $language->code) }}" />
